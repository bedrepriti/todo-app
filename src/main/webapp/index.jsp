...
<style>
body { height: 100vh; background: linear-gradient(135deg, #ff9ff3, #feca57); display:flex; justify-content:center; align-items:center; font-family: Arial, sans-serif; }
.card-signup { width: 450px; padding:30px; border-radius:15px; background:#fff; box-shadow:0 10px 25px rgba(0,0,0,0.15); }
.card-signup h1 { font-size:2rem; color:#ee5253; }
.btn-signup { width:100%; }
.msg { margin-bottom:15px; font-weight:500; text-align:center; }
</style>
</head>
<body>
...
<div class="card card-signup">
    ...
    <form action="adduser" method="post">  <!-- ✅ Matches SignUp.java mapping -->
        <div class="mb-3">
